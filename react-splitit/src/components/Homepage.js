              ...
              <div className="row" id="row1">
                ...
                <div className="col-sm-2 col-xs-2 col-md-2 col-lg-2">
                  <a id="login">Log in</a>
                        ...
                        <div className="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
                            <a id="registar" onClick={this.routeChange('/register')}>Register</a>
                </div>         
              </div>
                  ...
                  <div className="row" id="row4">
                    <div className="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                      <div id="circlemanager" className="circle">Manager</div>
                                    <button id="bmanager" className="button" onClick={this.routeChange('/loginadmin')} >Administrator Login</button>
                    </div>
                    <div className="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                      <div id="circlestaff" className="circle">Staff</div>
                                    <button id="bstaff" className="button" onClick={this.routeChange('/loginstaff')}>Staff Login</button>
                    </div>
                  </div>
                </div>
              </section>
